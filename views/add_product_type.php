                ...
                <div class="container h-100">
                    <div class="row h-100 justify-content-start">
                        ...
                        <div class="card-wrapper col-6" style="padding: 0px;">
                            <div class="card fat">
                                <div class="card-body">
                                    <h4 class="card-title " style="width:800px; margin:0 auto;">Thêm Type</h4>
                                    <form method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="type_ename">Ename</label>
                                            <input id="type_ename" type="text" class="form-control" name="type_ename"
                                                required autofocus>
                                        </div>
